...
const CACHE = 'exaustech-os-v144'; // v144 18/07: botão final da tela de separação vira "Registrar separação" e fica verde quando todos os itens já foram separados (era sempre azul, texto "Confirmar separação concluída")
