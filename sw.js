...
const CACHE = 'exaustech-os-v147'; // v147 18/07: reorganiza cores dos botões da tela de separação (pedido do Raphael) — toggle por item vira "Registrar separação" azul→VERDE quando separado; botão final volta a ser azul esmaecido→AZUL ESCURO (reverte o laranja/verde do v145, que agora fica só no toggle por item)
