...
const CACHE = 'exaustech-os-v169'; // v169 20/09: PROMOCAO DO BETA PARA A RAIZ. A FUNCAO DO CADASTRO PASSA A VALER DE VERDADE COMO PERMISSAO. O Salesforce guarda o cargo do RH (Sup. de Manutencao, Lider de equipe, Ger. de Contas, Tecnico, Soldador) e o app sempre decidiu permissao com outro vocabulario (Supervisor, Coordenador, Estoquista, ADM, Lider de Equipe com E maiusculo). Dos dois lados so Socio e Producao coincidiam, entao na pratica o sistema inteiro de permissao estava fechado para quem nao e socio: aprovacao de aviso, estoque, cadastro de ativo, plano, cotacao, levantamento, tratativa e alocacao. Agora existe uma tabela unica de traducao no backend (funcoes.js), aplicada uma vez no login, e nenhuma das rotas precisou mudar; a comparacao ignora acento e caixa. A funcao Estoquista foi criada na lista do Salesforce, Ger. de Contas e Ger. Financeiro valem como gerencia, e Aux. Adm assume o papel que o codigo chamava de ADM. O vinculo entre a conta Google e o recurso ganhou um caminho novo pelo E-MAIL do recurso, antes do casamento por nome: o caminho antigo exigia um usuario Salesforce por pessoa, ou seja, licenca paga para quem nunca abre o Salesforce. NA TELA: a etiqueta do canto passa a mostrar o cargo real (Soldador, Eletricista, Tecnico) em vez do papel interno; o seletor de perfil deixa de abrir quando ha sessao real, porque antes qualquer pessoa logada podia escolher Socio e abrir todos os modulos na tela; e quem entra sem cargo cadastrado cai no piso da escada, nao mais em Lider de Equipe. Backend correspondente na revisao exaustech-os-backend-00269-kx9. Provado clicando com a conta lider@exaustech.com.br, cargo Tecnico: etiqueta de auxiliar, agenda so com o que ele esta alocado, e Bipar e Estoque fora da barra. // v168 20/09: PROMOCAO DO BETA PARA A RAIZ. A VISITA LIGA O PLANO AO TECNICO, E A ALOCACAO DE EQUIPE PASSA A VALER TAMBEM PARA A ORDEM DE TRABALHO. A Agenda ganha o bloco Visitas do plano, com cliente, local, janela e quantas linhas ja foram resolvidas; a folha da visita traz a equipe com quem ja chegou, o que fazer no local, chegada e saida, o botao que abre o checklist da OT e o encerramento, tanto concluir quanto nao foi possivel concluir com motivo e preferencia do cliente, que faz nascer o retorno sem data. Na retaguarda, a Agenda de OTs ganha agendar visita (dia, hora, duracao e equipe), e a tela de Alocacao ganha uma segunda aba, Visitas do plano, com o mesmo arrastar da tela de OS, agora por visita da OT: grava no toque, o primeiro escalado e o lider, tocar em quem ja esta troca o lider, e quem ja registrou chegada nao sai da equipe porque presenca e fato. SEGURANCA (revisao geral de 20/09): o motor so aceita quem esta escalado na visita daquela OT e respeita OT assinada em toda escrita; o fluxo antigo de OS passa a exigir alocacao para gravar checklist e fechar OS, e cada pessoa carimba a propria presenca; a foto do motor volta a ser visivel para quem trabalhou nela; concluir tarefa virou idempotente, entao o reenvio da fila offline nao duplica mais achado nem corretiva; a OT deixa de fechar sozinha quando ainda ha visita aberta; a chegada grava a hora do aparelho e a localizacao, com a localizacao correndo contra 6 segundos para nunca travar o tecnico; e o CPF sai da lista geral de recursos, passando a vir so pela alocacao da OS. Backend correspondente na revisao exaustech-os-backend-00267-c9k. Provado clicando: visita aberta na agenda, chegada registrada, checklist aberto pela visita, equipe montada e lider trocado na tela nova. // v167 18/09: PROMOCAO DO BETA PARA A RAIZ. Dois consertos achados no teste clicando desta promocao: a foto do achado no painel de pendencias agora vem pelo proxy autenticado /arquivos/:driveId (antes ia a URL de visualizacao do Drive dentro do background-image, que nunca e imagem, e as aspas ainda cortavam o atributo: dava um quadrado cinza vazio), e o registro concluido de uma tarefa passa a mostrar o numero do passo de Calculo (antes mostrava um traco, mesmo com o valor gravado), com o selo de faixa aparecendo so quando existe faixa. O MONTADOR DO PLANO GANHA EDITOR DE PASSO E O ACHADO DO TECNICO VIRA PENDENCIA COM DONO E DESFECHO. Cada passo do POP passa a ser editavel na propria tela: tipo, unidade, faixa, opcoes, formula e modo NFC, com avisos que explicam o que esta faltando em portugues e botao de conserto de um clique, e previa que mostra quanto daria o calculo com valores de exemplo antes de salvar. Passo agora pode ser criado, reordenado arrastando e ARQUIVADO (nunca apagado, a regra de apagar nao vale para dado), e o passo de troca de peca busca o produto pelo nome. Atividade inteira pode ser copiada para outro plano. A condicao logica ganha duas fontes novas: o resultado de um passo de Calculo e o HISTORICO do proprio equipamento (ultima medicao, media das tres ultimas, mesma medicao do ano passado e ultima OT), o que permite escrever regra do tipo SE a vazao caiu mais de 20 por cento em relacao a ultima visita ENTAO marcar achado. Cada achado marcado no checklist passa a gerar UMA Anotacao Tecnica propria, com status (Aberta, Em analise, Resolvida, Descartada), a pergunta que deu origem, campo de medida corretiva e motivo obrigatorio quando se descarta; quando a gravidade pede corretiva, a OT corretiva ja nasce com o item do equipamento dentro. Painel de pendencias novo na aba Plano para fazer essa triagem pelo celular, com filtro por situacao e a foto do achado. Unidade bar entra na lista de unidades. Backend correspondente na revisao exaustech-os-backend-00262-jw9. Provado clicando: AT-00144 e AT-00145 abertas pelo checklist da OT, OT-0900 corretiva gerada com item, e triagem feita no painel. // v166 16/09: PROMOCAO DO BETA PARA A RAIZ. O MONTADOR DA REGRA LOGICA. A Biblioteca de regras da aba Plano deixa de ser vitrine: cada pergunta do POP lista as regras que a afetam, escritas em portugues do jeito que alguem leria em voz alta ("SE a resposta de Vazao medida na captacao for menor que 2400 E a resposta de Estado da correia for diferente de Bom ENTAO mostrar esta pergunta"), e ganha um construtor de se-entao ali mesmo, com criar, editar e apagar. O editor muda de forma conforme o que esta sendo montado, e as tres regras de validacao do Salesforce estao espelhadas no servidor pro erro chegar em portugues. A aba Plano passa a usar a tela inteira a partir de 760px, o que cobre iPad em pe e notebook com a janela pela metade, e em aparelho de toque os controles ganham alvo de dedo. A coluna de atividades fica parada enquanto os passos rolam. Backend correspondente na revisao exaustech-os-backend-00251-2bt. Provado clicando na biblioteca real: criar, editar e apagar regra, sem deixar dado de teste pra tras. // v165 15/09: PROMOCAO DO BETA PARA A RAIZ. A base da regra logica do formulario chega ao checklist do tecnico. Uma pergunta passa a poder ter VARIAS regras, e cada regra VARIAS condicoes unidas por E ou por OU, no lugar da condicao unica que so sabia mostrar ou esconder. Operadores novos: Esta preenchido, Esta vazio, Entre, e Fora da faixa deste equipamento (esse usa a faixa vigente ja resolvida pelo backend, sem repetir numero). Acoes novas: Ignorar secao, Tornar e Deixar de ser obrigatoria, Exigir foto, Preencher e travar, Sugerir valor, Marcar como achado com gravidade, Avisar sem travar, e Exigir para concluir como OK (que trava SOMENTE o botao Esta OK: Anotacao Tecnica e Nao executado seguem abertos sempre). O achado passa a ser DECLARADO pela regra em vez de adivinhado pela palavra "Ruim", o que destrava escrever a pergunta no positivo. Tipo de campo novo, Calculo: vazao = velocidade x area x 3600 feita no celular, com unidade e faixa proprias, gravada em Valor_Numerico__c e entrando na serie historica do equipamento como qualquer medicao. Valor escrito por regra e desfeito quando a regra deixa de valer, e a marca de quem escreveu sobrevive a fechar e reabrir o app; valor escrito pelo tecnico nunca e apagado. Objetos novos na MOB3: Regra_Logica__c e Condicao_Logica__c. Backend correspondente na revisao exaustech-os-backend-00250-mzc. Provado clicando na OT-0867. // v164 15/09: PROMOCAO DO BETA PARA A RAIZ. Os 6 tipos de passo que caiam em "sem campo nesta versao do app" (Picklist, Multi-Picklist, Texto, Contador, Data, NFC) ganham campo de verdade no checklist da OT; a resposta que o motor le como ACHADO ganha cor propria (antes "Bom" e "Ruim" ficavam iguais depois de tocados); medicao fora da faixa destaca o proprio campo; e o condicional passa a respeitar Passo_Regra__c.Operador__c nos 7 valores reais (Igual a, Diferente de, Contem, Maior que, Maior ou igual, Menor que, Menor ou igual) — antes so comparava igualdade. Backend correspondente na revisao exaustech-os-backend-00248-8md. Provado em campo na OT-0865. // v163 18/08: PROMOCAO DO BETA PARA A RAIZ. Entram na raiz: aprovacao de Pedido de Compra, assinatura do cliente com CPF travado pela Receita, OTP por WhatsApp, consumo WMS no ciclo da separacao, inventario (contagem cega por endereco) e o coletor escuro como tela titular. O registro do sw-beta.js foi removido e o selo BETA saiu; o SW da raiz (aviso de nova versao + registro do sw.js) foi preservado como estava na v162. // v162 09/08: HTML passa de network-first para stale-while-revalidate (abertura instantanea) + aviso de nova versao na tela; jsPDF com defer; preconnect do fonts.gstatic.com. // v161 04/08: as contagens de NF que o servidor RECUSA passam a ter copia auditavel no Salesforce (RecusaConferencia__c), com chave de idempotencia para reenvio nao duplicar. Antes morriam num arquivo do aparelho que nenhuma tela lia. Achado de auditoria. // v160 04/08: evidencia da assinatura passa a gravar o CANAL que confirmou o codigo (a producao gravava sem isso) e o celular do assinante vai junto no cadastro, para o numero deixar de existir so no aparelho. Achados de auditoria. // v159 04/08: fila offline PARA DE DESCARTAR assinatura/foto quando o servidor recusa ou a sessao expira. 401 vira falha passageira (espera o proximo login); recusa real vai pro cemiterio no aparelho COM a evidencia junto, e o aviso do topo fica vermelho ate alguem tratar. Achado de auditoria: uma assinatura colhida sem sinal podia sumir sem rastro. Fluxo de assinatura NAO foi tocado nesta versao. // v158 29/07: 2ª parte da promoção — Home do Estoque V3 escura vai pra RAIZ. CSS #scr-estoque (30 linhas) + estoqDarkPatch()/_EBG/_EBD/_ETX + renderEstoque() reescrito (dash com seções Pendências/Retorno/Filas/Ações, resto dos modos chamando estoqDarkPatch(wrap)) + estoqBuscaRenderResultados() escurece os resultados da busca. Confirmado que NÃO toca :root (CSS 100% escopado em #scr-estoque/#estoqBusca) — resto do app (Motor, Plano, Fotos, Armazém) continua claro.
