...
const CACHE = 'exaustech-os-v155'; // v155 26/07: conferencia passa a recusar 3 estados incoerentes ANTES de mandar pro Salesforce — status Pendente salvo em branco (foi assim que 2 itens do REC-000433 viraram quantidade 0), status que move saldo sem produto vinculado, e Conferido OK com quantidade zero. Espelha as validation rules novas de ItemRecebimento__c: la a regra vale pra qualquer caminho de gravacao, aqui e so pra mensagem sair em portugues em vez de DML cru.
