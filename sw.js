...
const CACHE = 'exaustech-os-v154'; // v154 26/07: 'PC'/'PEÇA' da NF passa a valer como 'UN' na comparacao de unidades. Levantamento no mob3 mostrou que o aviso de divergencia do v153 dispararia em 6 dos 9 itens, e 3 desses eram CALCA/CAMISA faturadas em PC com estoque em UN — ou seja, so vocabulario do fornecedor, 1:1. Os 3 casos reais (CANTONEIRA PC x M, SODA CAUSTICA SACO x KG, Damper PR x UN) continuam avisando.
